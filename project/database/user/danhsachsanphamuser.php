...
<div id="container1">
 ...
 <?php for($i = 1;$i <=  $page; $i++ ){ ?>
  ...
  <?php } ?>
        ...
        <button class="but1"><a class="buyed" href="sanphamdanggiao.php?userid=<?php echo $userid ?>">Sản phẩm đang giao</a></button>
        <button class="but1"><a class="buyed" href="sanphamdahuy.php?userid=<?php echo $userid ?>">Sản phẩm đã hủy</a></button>
        <button class="but1"><a class="buyed" href="sanphamdangchoxuly.php?userid=<?php echo $userid ?>">Sản phẩm đang chờ xử lý</a></button>
